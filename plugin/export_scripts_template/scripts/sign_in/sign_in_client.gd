...
signal firebase_auth_with_google_signal(token: String, old_firebase_id: String)
...
func _connect_signals() -> void:
    if GodotPlayGameServices.android_plugin:
        ...
        GodotPlayGameServices.android_plugin.firebaseAuthWithGoogleSignal.connect(func(token: String, old_firebase_id: String):
            firebase_auth_with_google_signal.emit(token, old_firebase_id)
        )
...
func firebase_check_user() -> void:
    if GodotPlayGameServices.android_plugin:
        GodotPlayGameServices.android_plugin.firebaseCheckConnectedUser()

func firebase_sign_in_anonymously() -> void:
    if GodotPlayGameServices.android_plugin:
