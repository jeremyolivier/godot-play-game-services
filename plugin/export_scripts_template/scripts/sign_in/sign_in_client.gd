...
signal firebase_auth_with_google_signal(new_token: String, old_token: String)
...
func _connect_signals() -> void:
    if GodotPlayGameServices.android_plugin:
        ...
        GodotPlayGameServices.android_plugin.firebaseAuthWithGoogleSignal.connect(func(new_token: String, old_token: String):
            firebase_auth_with_google_signal.emit(new_token, old_token)
        )
